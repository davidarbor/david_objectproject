...
var activeMon=new Partner("name", this.type1, this.type2, this.maxhp, this.currenthp, this.attack, this.defense, this.specialAttack, this.specialDefense, this.speed, this.selectionImage, this.battleImage, this.icon);
