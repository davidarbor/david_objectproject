...
decidueye.weaknesses=["Flying", "Ghost", "Fire", "Ice", "Dark"];
...
incineroar.weaknesses=["Fighting", "Ground", "Rock", "Water"];
...
primarina.weaknesses=["Poison", "Grass", "Electric"];
...
crabominable.weaknesses=["Fighting", "Flying", "Steel", "Fire", "Psychic", "Fairy"];
...
buzzwole.weaknesses=["Flying", "Fire", "Psychic", "Fairy"];
...
pheromosa.weaknesses=["Flying", "Fire", "Psychic", "Fairy"];
...
kartana.weaknesses=["Fighting", "Fire"];
...
celesteela.weaknesses=["Fire", "Electric"];
...
guzzlord.weaknesses=["Fighting", "Bug", "Ice", "Dragon", "Fairy"];
